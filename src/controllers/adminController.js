  ...
  try {
    ...
    if (rowsUpdated === 0) {
      return errorResponse(
        res,
        404,
        "User not found or status is not 'Pending'."
      );
    }
    ...
    return successResponse(
      res,
      200,
      `User ID ${userId} status updated to ${status}.`
    );
  } catch (error) {
...
export const blockUser = async (req, res) => {
  ...
  try {
    ...
    return successResponse(
      res,
      200,
      `User ID ${userId} and all associated data have been removed.`
    );
  } catch (error) {
...
export const removeListing = async (req, res) => {
  ...
  try {
    ...
    return successResponse(
      res,
      200,
      `Listing ID ${listingId} has been removed.`
    );
  } catch (error) {
